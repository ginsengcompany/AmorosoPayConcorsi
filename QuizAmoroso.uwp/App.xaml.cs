    ...
    sealed partial class App : Application
    {
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            if (rootFrame == null)
            {
               ...
               // var rendererAssemblies = new[] { typeof(Xamarin.Forms.Maps.UWP.MapRenderer).GetTypeInfo().Assembly };
               // var rendererAssemblies2 = new[] { typeof(OxyPlot.Xamarin.Forms.PlotView).GetTypeInfo().Assembly };


                Xamarin.Forms.Forms.Init(e, assembliesToInclude);
                ImageCircleRenderer.Init();
                FormsMaps.Init("uDPKJdpk7LKZ9MtW63ga~iddM2fn-euZ3WMV_hOQRyA~Apl4sKLWQnmYcGz8RlqvofVQE_R69Mh7m9PdK5cfy5YRXcs2f6TFcVjfVADgf52h");
